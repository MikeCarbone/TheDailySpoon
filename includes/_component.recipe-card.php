<li class="recipe-zone__recipe-card recipe-card">
	<a class="recipe-card__link" href= <?php echo "/templates/recipe.php?recipe-id={$recipeId}" ?>>
		...
		<div class="recipe-card__tag-container tag-container">
			<div class="icon-holder" title="Time Level">		
			...
			<div class="icon-holder" title="Spicy Level">
				<div class="icon icon-spicy">
			...
			<div class="icon-holder" title="Difficulty Level">
				<div class="icon icon-difficulty">
				...
				<?php echo "<span class='tag-container__difficulty-level'>{$difficultyLevel}</span>"; ?>
			</div>
